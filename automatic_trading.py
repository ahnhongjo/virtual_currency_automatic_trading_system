...
key = "e9e6667e43733e0c18ec4587d06578fe"
secret = "f7d977c08113280254641acda3aeb2c3"
bithumb = pybithumb.Bithumb(key, secret)

form_class = uic.loadUiType("automatic_trading.ui")[0]
...
class Calculation(QThread):
    ...
    def run(self):
        ...
        def buy_crypto_currency(ticker):
            ...
            krw_by_coin[ticker] = krw_by_coin[ticker] - buy_unit * buy_price[ticker]
        ...
        def sell_crypto_currency(ticker):
            ...
            krw_by_coin[ticker] = krw_by_coin[ticker] + sell_unit * sell_price[ticker]
        ...
        for ticker in major_ticker:
            ...
            # 장대양봉, 장대음봉(실행시 한번)
            jang_dae_plus[ticker] = abs(current_price[ticker] - to_open) > to_open * jang_plus_cnst
            ...
            jang_dae_plus_volume[ticker] = jang_dae_plus[ticker] and (to_volume > volume_aver * 2)
            jang_dae_minus_volume[ticker] = jang_dae_minus[ticker] and (to_volume > volume_aver * 2)
...
class MyWindow(QMainWindow, form_class):
    def __init__(self):
        ...
        self.ticker_setting()
        self.cal.finished.connect(self.update_table_widget)
    ...
    def ticker_setting(self):
        for ticker in major_ticker:
            index = major_ticker.index(ticker)
